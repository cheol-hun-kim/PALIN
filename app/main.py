...
def get_student(student_id: int, db: Session = Depends(get_db)):
    ...
    return {
        ...
        "b2c_subscription_tier": "TIER_4_ILWON" if student.id == 1 or str(student.email).lower() == "1286orbital21@gmail.com" else "TIER_1_FREE",
...
def get_admin_dashboard(tenant_code: Optional[str] = "ILWON-2027", db: Session = Depends(get_db)):
    ...
    for s in students:
        ...
        student_list.append({
            ...
            "b2c_subscription_tier": "TIER_4_ILWON" if s.id == 1 or str(s.email).lower() == "1286orbital21@gmail.com" else "TIER_1_FREE",
